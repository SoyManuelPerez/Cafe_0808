...
def generar_factura_pdf(documento, items, es_cotizacion=False):
    ...
    if es_cotizacion:
        ...
        tipo_doc_titulo = "FACTURA DE VENTA"
        label_num = "Factura N°:"
